...
- `docs/chats/0017-temp-module-disposal-and-dsl-extension-patterns.md` - DSL extension patterns
- `docs/chats/0003-bytevector-and-vertical-bar-syntax.md` - Vertical bar syntax discussion
