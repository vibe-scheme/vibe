...
- `docs/chats/0012-ffi-refactor-and-segfault-fix.md` - Previous session on FFI and segfault fixes
- `docs/design/bootstrap-plan.md` - Bootstrap compiler architecture
