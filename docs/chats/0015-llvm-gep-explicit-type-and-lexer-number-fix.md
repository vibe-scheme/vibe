...
- `docs/chats/0014-llvm-gep-type-inference.md` - Previous attempt at type inference (reversed)
- `docs/chats/0013-let-star-binding-storage-and-retrieval.md` - Context on `let*` work
