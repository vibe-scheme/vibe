...
3. **doc/design/r7rs-syntax.bnf** (new): Complete R7RS formal syntax reference
...
- `doc/design/r7rs-syntax.bnf`: Complete R7RS syntax reference with Vibe implementation notes
- `doc/chats/0018-array-type-parsing-and-architectural-separation.md`: Previous work on array types
