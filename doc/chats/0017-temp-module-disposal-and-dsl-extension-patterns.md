...
- `doc/chats/0012-ffi-refactor-and-segfault-fix.md` - DSL extension work (FFI functions, llvm:array)
- `doc/chats/0013-let-star-binding-storage-and-retrieval.md` - let* special form implementation
- `doc/chats/0014-llvm-gep-type-inference.md` - Type resolution patterns
