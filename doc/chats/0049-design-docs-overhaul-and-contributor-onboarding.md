...
- `doc/design/bootstrap-plan.md` — historical bootstrap compiler plan
- `doc/design/narrow-bootstrap-goal.md` — historical hello-world milestone
- `doc/design/ffi-llvm-integration.md` — historical FFI/LLVM integration design

**Updated still-relevant documents:**
- `doc/design/cross-compilation-plan.md` — removed stale `bootstrap/codegen.ll` sync reference and `types.ll` mention
- `doc/design/llvm-dsl-deferred-methods.md` — updated implementation pattern to reference only `kernel/dsl.vibe` and `kernel/codegen.vibe`

**Created three new foundational documents:**
- `doc/design/vision.md` — Vibe's mission (human+AI co-reasoning about programs), two goals (R7RS via macros, binding registry), downstream possibilities (conversational programming, verified transformation, self-modifying runtime), current state, and architecture layer diagram
- `doc/design/primitive-forms.md` — analysis of why `define`, `lambda`, `if`, `set!`, `quote`, and `define-syntax`/`syntax-rules` must be primitive; full derived forms catalog; mapping to LLVM generation patterns; docstring design note
- `doc/design/r7rs-compliance.md` — section-by-section tracker for all of R7RS Small (sections 4-6 + standard libraries), with macro-first implementation order

### 2. Macro System Design Document

Created `doc/design/macro-system.md` capturing:
...
Updated `doc/design/r7rs-compliance.md` implementation strategy section to reference the macro-first approach.
...
- Updated directory structure to include `doc/pages/`
...
- Added docstring design note to `doc/design/primitive-forms.md` (Python-style first-string-in-body convention)
...
## Files Created
- `doc/design/vision.md`
- `doc/design/primitive-forms.md`
- `doc/design/r7rs-compliance.md`
- `doc/design/macro-system.md`
- `doc/pages/index.html`
- `.github/workflows/renumber-chat.yml`
- `CONTRIBUTING.md`
- `LICENSE`
- `doc/chats/0049-design-docs-overhaul-and-contributor-onboarding.md` (this file)

## Files Modified
- `doc/design/bootstrap-plan.md` (archival header)
- `doc/design/narrow-bootstrap-goal.md` (archival header)
- `doc/design/ffi-llvm-integration.md` (archival header)
- `doc/design/cross-compilation-plan.md` (removed bootstrap references)
- `doc/design/llvm-dsl-deferred-methods.md` (removed bootstrap references)
- `AGENTS.md` (comprehensive update)

## Related Documents
- `doc/design/vision.md` — Vibe's mission and goals
- `doc/design/primitive-forms.md` — primitive vs. derived form analysis
- `doc/design/macro-system.md` — macro-first implementation strategy
- `doc/design/r7rs-compliance.md` — R7RS Small compliance tracker
