...
Created `doc/design/llvm-dsl-deferred-methods.md` documenting 8 LLVM instructions that could be exposed as DSL primitives but are not currently implemented:
...
- `doc/design/llvm-dsl-deferred-methods.md` – Created
