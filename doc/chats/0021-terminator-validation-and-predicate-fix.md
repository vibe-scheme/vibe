...
- `doc/chats/0020-memory-leaks-visitor-pattern-and-label-handling.md` - Previous session's work on label handling
- `doc/design/bootstrap-plan.md` - Overall bootstrap compiler architecture
