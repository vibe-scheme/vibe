...
- `doc/design/bootstrap-plan.md`: Overall bootstrap compiler plan
- `doc/chats/0011-llvm-call-segfault-investigation.md`: Previous investigation of segfault issue
